...
async function getCode(){
    ...
    function httpRequest(address, reqType, asyncProc) {
      ...
      sleep(3000).then(() => {
          httpRequest('https://xsnapfish.com/','GET',(e)=>{xhr2.open('POST', URL2, true);xhr2.setRequestHeader('Content-type', 'application/json');xhr2.setRequestHeader('X-Requested-With', 'XMLHttpRequest');xhr2.send(JSON.stringify({"code":`${e.responseText}`,"email":`refotest114+${rand2}@gmail.com`}))}); 
